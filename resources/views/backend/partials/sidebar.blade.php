    ...
    <div class="aside-menu flex-column-fluid ps-3 pe-1">
        ...
        <div class="my-5 menu menu-sub-indention menu-column menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-active-bg menu-state-primary menu-arrow-gray-500 fw-semibold fs-6 mt-lg-2 mb-lg-0"
            ...
            <div class="mx-4 hover-scroll-y" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                ...
                <div class="menu-item">
                    <a class="menu-link {{ request()->routeIs('admin.support.*') ? 'active' : '' }}"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item {{ request()->routeIs(['profile.setting', 'stripe.setting', 'paypal.setting', 'dynamic_page.*', 'system.index', 'mail.setting', 'social.index', 'stripe.settings']) ? 'active show' : '' }} menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <a href="{{ route('stripe.settings') }}"
                                class="menu-link {{ request()->routeIs('stripe.settings') ? 'active' : '' }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
