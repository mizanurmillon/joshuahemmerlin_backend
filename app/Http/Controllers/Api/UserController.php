...
class UserController extends Controller
{
    ...
    public function userData()
    {
        ...
        $data = User::with('logo')->find($user->id);
        ...
        if ($data->role == 'admin') {
            ...
            $is_membership = true;
            $data->load(
                'roleAccess:user_id,role_id,access',
                'roleAccess.role.role_permission:id,role_id,permission_id,is_permission',
                'roleAccess.role.role_permission.permission:id,permission_name'
        ...
        $data->setAttribute('is_membership', $is_membership);
        $data->setAttribute('email_verified', $flag);
